...
// Demo feed — mirrors the exact shape scan.js writes to data/feed.json.
const now = Date.now();
const ago = (m) => new Date(now - m * 60000).toISOString();
const SEED = [
  { id: "a1", agency: "Russell Tobin", title: "Remote Customer Support Agent (Chat)", category: "Chat Support", location: "Remote · US", source: "Greenhouse", url: "https://www.russelltobin.com", postedAt: ago(7), firstSeen: ago(7) },
  { id: "a2", agency: "HealthCare Support", title: "Member Services Representative — Work From Home", category: "Member Services", location: "Remote · US", source: "Careers page", url: "https://www.healthcaresupport.com", postedAt: ago(21), firstSeen: ago(21) },
  { id: "a3", agency: "Medix", title: "Medical Records Retrieval Specialist (Remote)", category: "Medical Records", location: "Remote · US", source: "Careers page", url: "https://www.medixteam.com", postedAt: ago(44), firstSeen: ago(44), byod: true, equipment: ["Windows 10/11 laptop", "USB/wired headset", "Wired/Ethernet internet"] },
  { id: "a4", agency: "CornerStone Staffing", title: "Remote Call Center Agent — Healthcare Project", category: "Call Center", location: "Remote · TX pref.", source: "JSearch", url: "https://www.cornerstonestaffing.com", postedAt: ago(58), firstSeen: ago(58), maybeHybrid: false },
  { id: "a5", agency: "Wahve", title: "Remote Insurance CSR (Work-At-Home)", category: "Customer Service", location: "Remote · US", source: "Careers page", url: "https://www.wahve.com", postedAt: ago(96), firstSeen: ago(96) },
  { id: "a6", agency: "RemX", title: "Data Entry Specialist — Fully Remote", category: "Data Entry", location: "Remote · US", source: "Careers page", url: "https://www.remx.com", postedAt: ago(140), firstSeen: ago(140) },
  { id: "a7", agency: "The CSI Companies", title: "Patient Access Representative (Remote)", category: "Member Services", location: "Remote · US", source: "Careers page", url: "https://www.thecsicompanies.com", postedAt: ago(180), firstSeen: ago(180) },
  { id: "a8", agency: "Scion Staffing", title: "Customer Service Representative — Remote Contract", category: "Customer Service", location: "Remote · US", source: "Lever", url: "https://www.scionstaffing.com", postedAt: ago(260), firstSeen: ago(260) },
  { id: "a9", agency: "Zempleo", title: "Call Center / Customer Service Rep – 100% Remote", category: "Call Center", location: "Remote · US", source: "JSearch", url: "https://www.zempleo.com", postedAt: ago(320), firstSeen: ago(320), byod: true, equipment: ["Dual monitors", "Webcam"] },
  { id: "a10", agency: "Green Key Resources", title: "Remote Medical Billing & Records Clerk", category: "Medical Records", location: "Remote · US", source: "Careers page", url: "https://www.greenkeyllc.com", postedAt: ago(410), firstSeen: ago(410) },
  { id: "a11", agency: "TalentBridge", title: "Remote Customer Service Rep (Hybrid option)", category: "Customer Service", location: "Remote / Charlotte", source: "Careers page", url: "https://www.talentbridge.com", postedAt: ago(520), firstSeen: ago(520), maybeHybrid: true },
  { id: "a12", agency: "Complete Staffing Solutions", title: "Medical Receptionist — Remote Data Entry", category: "Data Entry", location: "Remote · MA", source: "Careers page", url: "https://www.completestaffingsolutions.com", postedAt: ago(700), firstSeen: ago(700) },
  { id: "a13", agency: "Working Solutions", title: "Independent Contractor — Remote Chat & Phone CSR", category: "Chat Support", location: "Remote · US (1099)", source: "Careers page", url: "https://www.workingsolutions.com", postedAt: ago(900), firstSeen: ago(900) },
  { id: "a14", agency: "Thrivas", title: "Remote Data Entry Clerk (Part-Time)", category: "Data Entry", location: "Remote · US", source: "Careers page", url: "https://www.thrivas.com", postedAt: ago(1300), firstSeen: ago(1300) },
];

/* ---- window.storage helpers (with in-memory fallback) ---- */
const mem = {};
async function sget(k, d) {
  try { const r = await window.storage.get(k); return r ? JSON.parse(r.value) : (k in mem ? mem[k] : d); }
  catch { return k in mem ? mem[k] : d; }
}
async function sset(k, v) {
  mem[k] = v;
  try { await window.storage.set(k, JSON.stringify(v)); } catch { /* fallback: memory only */ }
}
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.text, fontFamily: SANS }}>
      ...
      <main style={{ maxWidth: 920, margin: "0 auto", padding: "18px 18px 80px" }}>
        ...
        <p style={{ marginTop: 26, fontFamily: MONO, fontSize: 11, color: T.faint, lineHeight: 1.7 }}>
          Demo feed. Once the monitor is live, this list is driven by <code>data/feed.json</code>,
          refreshed every sweep. Links open the real posting.
        </p>
      </main>
